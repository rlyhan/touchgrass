...
export const patternTypes: PatternType[] = [
  // Group 1 — Extraversion × Agreeableness
  {
    ...
    groupId: 1,
    name: 'Personable',
    shortDescription: 'Warm, outgoing, friendly, and socially engaging.',
  ...
  },
  {
    ...
    shortDescription: 'Confident, dominant, persuasive, and socially forceful.',
    traitA: { trait: 'Extraversion', level: 'H' },
  ...
  },
  {
    ...
    shortDescription: 'Quiet, cooperative, modest, and accommodating.',
  ...
  },
  {
    ...
    shortDescription: 'Independent, skeptical, private, and emotionally distant.',
    traitA: { trait: 'Extraversion', level: 'L' },
    traitB: { trait: 'Agreeableness', level: 'L' },
  },
  ...
  // Group 2 — Extraversion × Conscientiousness
  {
    ...
    groupId: 2,
    name: 'Enterprising',
    shortDescription: 'Energetic, ambitious, achievement-oriented, and proactive.',
    traitA: { trait: 'Extraversion', level: 'H' },
  ...
  },
  {
    ...
    shortDescription: 'Excitement-seeking, spontaneous, and less disciplined.',
    traitA: { trait: 'Extraversion', level: 'H' },
  ...
  },
  {
    ...
    shortDescription: 'Dependable, disciplined, quiet, and steady.',
    traitA: { trait: 'Extraversion', level: 'L' },
    traitB: { trait: 'Conscientiousness', level: 'H' },
  },
  {
    ...
    shortDescription: 'Low-energy, unstructured, and less motivated.',
    traitA: { trait: 'Extraversion', level: 'L' },
    traitB: { trait: 'Conscientiousness', level: 'L' },
  },
  ...
  // Group 3 — Extraversion × Neuroticism
  {
    ...
    shortDescription: 'Emotionally reactive, expressive, and intense.',
    traitA: { trait: 'Extraversion', level: 'H' },
  ...
  },
  {
    ...
    shortDescription: 'Outgoing, emotionally stable, and resilient.',
    traitA: { trait: 'Extraversion', level: 'H' },
  ...
  },
  {
    ...
    shortDescription: 'Quiet, anxious, self-conscious, and socially avoidant.',
    traitA: { trait: 'Extraversion', level: 'L' },
    traitB: { trait: 'Neuroticism', level: 'H' },
  },
  {
    ...
    groupId: 3,
    name: 'Contented',
    shortDescription: 'Emotionally steady, independent, and low-key.',
    traitA: { trait: 'Extraversion', level: 'L' },
    traitB: { trait: 'Neuroticism', level: 'L' },
  },
  ...
  // Group 4 — Extraversion × Openness
  {
    ...
    shortDescription: 'Curious, energetic, novelty-seeking, and expressive.',
    traitA: { trait: 'Extraversion', level: 'H' },
  ...
  },
  {
    ...
    shortDescription: 'Outgoing, practical, and socially engaged.',
    traitA: { trait: 'Extraversion', level: 'H' },
  ...
  },
  {
    ...
    shortDescription: 'Imaginative, reflective, and inwardly focused.',
    traitA: { trait: 'Extraversion', level: 'L' },
    traitB: { trait: 'Openness', level: 'H' },
  },
  {
    ...
    shortDescription: 'Reserved, practical, and resistant to change.',
    traitA: { trait: 'Extraversion', level: 'L' },
    traitB: { trait: 'Openness', level: 'L' },
  },
  ...
  // Group 5 — Agreeableness × Conscientiousness
  {
    ...
    groupId: 5,
    name: 'Compromising',
    shortDescription: 'Helpful, responsible, cooperative, and trustworthy.',
  ...
  },
  {
    ...
    shortDescription: 'Friendly and relaxed, but less structured or driven.',
    traitA: { trait: 'Agreeableness', level: 'H' },
    traitB: { trait: 'Conscientiousness', level: 'L' },
  },
  {
    ...
    shortDescription: 'Disciplined, demanding, and focused on standards.',
  ...
  },
  {
    ...
    shortDescription: 'Independent, disorganized, and resistant to expectations.',
    traitA: { trait: 'Agreeableness', level: 'L' },
    traitB: { trait: 'Conscientiousness', level: 'L' },
  },
  ...
  // Group 6 — Agreeableness × Neuroticism
  {
    ...
    shortDescription: 'Compassionate, emotionally reactive, and empathetic.',
    traitA: { trait: 'Agreeableness', level: 'H' },
    traitB: { trait: 'Neuroticism', level: 'H' },
  },
  {
    ...
    groupId: 6,
    name: 'Pleasant',
    shortDescription: 'Kind, patient, emotionally balanced, and supportive.',
    traitA: { trait: 'Agreeableness', level: 'H' },
    traitB: { trait: 'Neuroticism', level: 'L' },
  },
  {
    ...
    shortDescription: 'Critical, defensive, and emotionally volatile.',
    traitA: { trait: 'Agreeableness', level: 'L' },
    traitB: { trait: 'Neuroticism', level: 'H' },
  },
  {
    ...
    groupId: 6,
    name: 'Stable Realist',
    shortDescription: 'Emotionally detached, skeptical, and resilient.',
    traitA: { trait: 'Agreeableness', level: 'L' },
    traitB: { trait: 'Neuroticism', level: 'L' },
  },
  ...
  // Group 7 — Agreeableness × Openness
  {
    ...
    groupId: 7,
    name: 'Tolerant',
    shortDescription: 'Empathetic, imaginative, and open-minded.',
    traitA: { trait: 'Agreeableness', level: 'H' },
    traitB: { trait: 'Openness', level: 'H' },
  },
  {
    ...
    shortDescription: 'Friendly, dependable, and conventional in outlook.',
    traitA: { trait: 'Agreeableness', level: 'H' },
    traitB: { trait: 'Openness', level: 'L' },
  },
  {
    ...
    shortDescription: 'Independent thinker who values originality and autonomy.',
    traitA: { trait: 'Agreeableness', level: 'L' },
    traitB: { trait: 'Openness', level: 'H' },
  },
  {
    ...
    shortDescription: 'Practical, skeptical, and resistant to emotional influence.',
    traitA: { trait: 'Agreeableness', level: 'L' },
    traitB: { trait: 'Openness', level: 'L' },
  },
  ...
  // Group 8 — Conscientiousness × Neuroticism
  {
    ...
    shortDescription: 'Highly driven, organized, and prone to worry.',
  ...
  },
  {
    ...
    groupId: 8,
    name: 'Persistent',
    shortDescription: 'Reliable, disciplined, and emotionally composed.',
    traitA: { trait: 'Conscientiousness', level: 'H' },
    traitB: { trait: 'Neuroticism', level: 'L' },
  },
  {
    ...
    shortDescription: 'Unstructured, emotionally overwhelmed, and inconsistent.',
  ...
  },
  {
    ...
    shortDescription: 'Calm, flexible, and unconcerned with rigid structure.',
    traitA: { trait: 'Conscientiousness', level: 'L' },
    traitB: { trait: 'Neuroticism', level: 'L' },
  },
  ...
  // Group 9 — Conscientiousness × Openness
  {
    ...
    shortDescription: 'Curious, disciplined, and improvement-oriented.',
    traitA: { trait: 'Conscientiousness', level: 'H' },
    traitB: { trait: 'Openness', level: 'H' },
  },
  {
    ...
    groupId: 9,
    name: 'Conventional',
    shortDescription: 'Structured, practical, and tradition-oriented.',
    traitA: { trait: 'Conscientiousness', level: 'H' },
    traitB: { trait: 'Openness', level: 'L' },
  },
  {
    ...
    shortDescription: 'Imaginative and unconventional, but less structured.',
    traitA: { trait: 'Conscientiousness', level: 'L' },
    traitB: { trait: 'Openness', level: 'H' },
  },
  {
    ...
    shortDescription: 'Routine-oriented with low drive for novelty or planning.',
    traitA: { trait: 'Conscientiousness', level: 'L' },
    traitB: { trait: 'Openness', level: 'L' },
  },
  ...
  // Group 10 — Neuroticism × Openness
  {
    ...
    groupId: 10,
    name: 'Sensitive',
    shortDescription: 'Highly sensitive, imaginative, and emotionally deep.',
  ...
  },
  {
    ...
    groupId: 10,
    name: 'Traditionalist',
    shortDescription: 'Worried, cautious, and uncomfortable with uncertainty.',
    traitA: { trait: 'Neuroticism', level: 'H' },
    traitB: { trait: 'Openness', level: 'L' },
  },
  {
    ...
    groupId: 10,
    name: 'Clear-Thinking',
    shortDescription: 'Curious, emotionally balanced, and intellectually open.',
  ...
  },
  {
    ...
    shortDescription: 'Calm, practical, and emotionally restrained.',
    traitA: { trait: 'Neuroticism', level: 'L' },
    traitB: { trait: 'Openness', level: 'L' },
  },
];
